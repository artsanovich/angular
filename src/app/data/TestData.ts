...
export class TestData {
  ...
  static priorities: Priority[] = [
    ...
    {id: 2, title: 'Средний', color: '#85d1b1'},
  ...
  static tasks: Task[] = [
    {
      id: 1,
      title: 'Залить бензина полный бак',
    ...
    {
      id: 5,
      title: 'Выучить учебник по квантовой физике',
      completed: false,
    ...
    {
      id: 8,
      title: 'Приготовить ужин для семьи',
      completed: false,
    ...
    {
      id: 12,
      title: 'Сходить на лекцию по Java',
      priority: TestData.priorities[1],
      completed: false,
      category: TestData.categories[2]
    },
    ...
    {
      id: 14,
      title: 'Провести собрание по вопросам проекта',
      completed: false,
      category: TestData.categories[0]
    },
    ...
    {
      id: 16,
      title: 'Положить 100к в банк на депозит',
    ...
    {
      id: 19,
      title: 'Сравнить телефон с планшетом',
      priority: TestData.priorities[0],
      completed: false,
